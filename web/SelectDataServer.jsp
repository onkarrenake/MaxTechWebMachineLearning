...
//                        ArrayList list_data = new ArrayList();
                        ...
                        List<String> request_list = method.getrequest(2);
                        int i1 = 0;
...
//                            if (i1 % 2 == 0) {
                ...
                <tr class="active">
                    ...
                    %>
                    <td><a href='ShowDataServer?id=<%=list_data[0]%>&uname=<%=list_data[1]%>&email=<%=list_data[2]%>&cname=<%=list_data[3]%>&tname=<%=list_data[4]%>&type=<%=list_data[5]%>'>Show Data</a></td>
                </tr>
                <%
                    }
